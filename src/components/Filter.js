...
const Filter = ({role, setRole, numOfEmployees, setNumOfEmployees, experience, setExperience, remote, setRemote, minBasePay, setMinBasePay, companyName, setCompanyName}) => {
  ...
  return (
    <>
          <Stack spacing={2} direction={'row'} useFlexGap flexWrap="wrap" justifyContent={{sm:'flex-start', md:'center'}} marginBottom={4}>
              <Autocomplete
                  id='Role'
                  disablePortal
                  multiple
      ...
      renderInput={(params) => <TextField {...params} label="Role" />}
              ...
              <Autocomplete
                  ...
                  onChange={(e) => {
                      ...
                      e?.target?.innerText && setNumOfEmployees([...numOfEmployees, e?.target?.innerText]);
                  }}
      size='small'
      renderInput={(params) => <TextField {...params} label="Number Of Employees" />}
              ...
              <Autocomplete
                  ...
                  style={{maxWidth: "10rem"}}
                  onChange={(e) => {
                     e?.target?.innerText && setExperience([...experience, e?.target?.innerText]);
                  }}
      size='small'
    ...
    />
              <Autocomplete
                  ...
                  style={{maxWidth: "10rem"}}
                  onChange={(e) => {
                      e?.target?.innerText && setRemote([...remote, e?.target?.innerText]);
                  }}
      size='small'
    ...
    />
              <Autocomplete
                  ...
                  style={{maxWidth: "15rem"}}
                  onChange={(e) => {
                      e?.target?.innerText && setMinBasePay([...minBasePay, e?.target?.innerText]);
                  }}
      size='small'
