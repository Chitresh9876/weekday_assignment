...
const Jobcard = ({ role, location, minSalary, maxSalary, jobDetail, minExperiance, applyLink }) => {
    ...
    // Constant to display Job role and location 
  const subtitle = (
    <ul style={{ listStyle: "none" }}>
      <li>{role}</li>
      <li style={{ fontSize: "0.7rem", fontWeight: "550" }}>{location}</li>
    </ul>
  );
        ...
        <CardContent>
          ...
          >
            ...
            <img
              src={tick}
              alt="tick"
              style={{ height: "0.9rem", marginBottom: "-0.1rem" }}
            />
          </Typography>
          <Typography
            variant="h6"
